...
const quizIdByNpcId: Record<string, string> = {
  "de-verwoeste-stad-02": "professor_quiz",
  "de-verwoeste-stad-04": "benjamin_quiz",
};

const rewardIdByQuizId: Record<string, string> = {
  professor_quiz: "Zandloper onderdeel 1",
  benjamin_quiz: "Experimenteel zand",
};
